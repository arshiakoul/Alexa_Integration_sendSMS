...
def get_welcome_response():
    ...
    intro = ("Welcome to SMSsender, Just ask {} to send a message. ".format(SKILL_NAME)) 
...
def handle_dadintent_request(intent, session):
    ...
    reprompt_text = "Try SMSsender {} once, please, please".format(SKILL_NAME)
    url = 'https://atmosphere-api.SMSsender.com/rest/v1/smartflows/apitrigger'

    payload = json.dumps({
    "flowId": "626b8533d86a325c1293a03f",
    "ANI": "+13035061857",
    "DNIS": "+13032232104"
     })
    headers = {
               'Authorization': 'eyJhbGciOiJSUzI1NiJ9.eyJjaWQiOiI0MDAwMjczIiwiY3RkIjoxNjQyNzA5Mjk0LCJleHAiOjIxNDU5MTY4MDAsInNyYyI6ImVDb21tZXJjZSIsInVpZCI6IjYwMTM2ZTczOTcxZDZhMzAxZDJlMDY0ZCJ9.IFMpL_4JcO5nD3-HTCUddOfUtw3bTPt7Tk-d9fgJQfylzwntDwvwoJsyGHsciF6OtlK-BJ1iAjsTjQ2KWvAcxw',
            'Content-Type': 'application/json'
    }
    response = requests.request("POST", url, headers=headers, data=payload)
    print(response.text)
    speech_output=("SMSsender has just sent your message")
    print(speech_output)
